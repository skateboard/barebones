...
public class ChromeFingerprint implements Fingerprint{
    ...
    public WebClientOptions options() {
        var options = new WebClientOptions()
                ...
                .setTrustAll(true).setVerifyHost(true).setForceSni(true)
                .setConnectTimeout(10000).setSslHandshakeTimeout(10000)
                .setSslHandshakeTimeoutUnit(TimeUnit.SECONDS)
                .setIdleTimeoutUnit(TimeUnit.SECONDS)
                .setIdleTimeout(10000)
                .setKeepAlive(true)
                .setKeepAliveTimeout(50)
                .setHttp2KeepAliveTimeout(100)
                .setHttp2MaxPoolSize(10)
                .setHttp2MultiplexingLimit(150)
